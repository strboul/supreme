...
The **supreme** package provides an example path containing a dummy Shiny application
created with modules. The modeling graph generation can be called in three easy steps:

1. You can get the paths for the example app by calling `example_app_path()`

2. Read as *supreme* object.
