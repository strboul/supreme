...
knitr::opts_chunk$set(fig.path = "inst/media/", dev = "png")
```
...
*supreme* helps you structure your Shiny application developed with modules
...
+ Keep track of your modules that are either placed in the different parts or reused
in multiple places in your existing application
...
+ *supreme* does a static analysis on the code thanks to *R* allowing to manipulate
*abstract syntax trees* (AST) easily.
