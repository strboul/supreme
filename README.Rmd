...
The Shiny application has to first be read as a model object by *supreme*.

For your existing application, you may read it from a file by using `src_file()`.
Please see the vignette for the other options to read your application as model
objects.
